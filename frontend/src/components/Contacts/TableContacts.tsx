...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/contacts/contactsSlice';
...
const TableSampleContacts = ({ filterItems, setFilterItems, filters }) => {
  ...
  const handleViewAction = (id: string) => {
    router.push(`/contacts/contacts-view/?id=${id}`);
  };
