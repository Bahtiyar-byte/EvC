...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/estimates/estimatesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureEstimatesCols';
...
const TableSampleEstimates = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (estimatesNotify.showNotification) {
      notify(
        estimatesNotify.typeNotification,
        estimatesNotify.textNotification,
      );
    }
  }, [estimatesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/estimates/estimates-view/?id=${id}`);
  };
...
export default TableSampleEstimates;
