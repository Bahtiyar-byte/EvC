...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/invoices/invoicesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureInvoicesCols';
...
const TableSampleInvoices = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (invoicesNotify.showNotification) {
      notify(invoicesNotify.typeNotification, invoicesNotify.textNotification);
    }
  }, [invoicesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/invoices/invoices-view/?id=${id}`);
  };
...
export default TableSampleInvoices;
