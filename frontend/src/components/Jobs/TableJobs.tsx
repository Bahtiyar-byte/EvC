...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/jobs/jobsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureJobsCols';
...
const TableSampleJobs = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (jobsNotify.showNotification) {
      notify(jobsNotify.typeNotification, jobsNotify.textNotification);
    }
  }, [jobsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/jobs/jobs-view/?id=${id}`);
  };
...
export default TableSampleJobs;
