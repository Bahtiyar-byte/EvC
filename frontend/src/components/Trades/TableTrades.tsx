...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/trades/tradesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTradesCols';
...
const TableSampleTrades = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (tradesNotify.showNotification) {
      notify(tradesNotify.typeNotification, tradesNotify.textNotification);
    }
  }, [tradesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/trades/trades-view/?id=${id}`);
  };
...
export default TableSampleTrades;
